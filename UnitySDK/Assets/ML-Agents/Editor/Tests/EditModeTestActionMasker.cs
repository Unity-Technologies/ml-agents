...
namespace MLAgents.Tests
{
    public class EditModeTestActionMasker
    {
        ...
        {
            var bp = new BrainParameters { vectorActionSpaceType = SpaceType.Continuous, vectorActionSize = new[] { 4 } };
            var masker = new ActionMasker(bp);
        ...
        {
            var bp = new BrainParameters
            { vectorActionSpaceType = SpaceType.Discrete, vectorActionSize = new[] { 4, 5, 6 } };
            var masker = new ActionMasker(bp);
            var mask = masker.GetMask();
            Assert.IsNull(mask);
        ...
        {
            var bp = new BrainParameters { vectorActionSpaceType = SpaceType.Discrete, vectorActionSize = new[] { 4, 5, 6 } };
            var masker = new ActionMasker(bp);
