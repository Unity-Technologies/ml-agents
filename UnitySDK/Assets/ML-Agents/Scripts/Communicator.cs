...
namespace MLAgents
{
    ...
    UnityOutput and UnityInput can be extended to provide functionality beyond RL
    UnityRLOutput and UnityRLInput can be extended to provide new RL functionality
     */
