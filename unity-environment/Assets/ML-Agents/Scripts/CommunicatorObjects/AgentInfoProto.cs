...
namespace MLAgents.CommunicatorObjects {
    ...
    static AgentInfoProtoReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "EhRjb21tdW5pY2F0b3Jfb2JqZWN0cyKVAgoOQWdlbnRJbmZvUHJvdG8SIgoa",
            ...
            "aWQYCiABKAUSFgoObWFza2VkX2FjdGlvbnMYCyADKAhCH6oCHE1MQWdlbnRz",
            "LkNvbW11bmljYXRvck9iamVjdHNiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::MLAgents.CommunicatorObjects.AgentInfoProto), global::MLAgents.CommunicatorObjects.AgentInfoProto.Parser, new[]{ "StackedVectorObservation", "VisualObservations", "TextObservation", "StoredVectorActions", "StoredTextActions", "Memories", "Reward", "Done", "MaxStepReached", "Id", "MaskedActions" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class AgentInfoProto : pb::IMessage<AgentInfoProto> {
    ...
    public AgentInfoProto(AgentInfoProto other) : this() {
      ...
      id_ = other.id_;
      maskedActions_ = other.maskedActions_.Clone();
    ...
    /// <summary>Field number for the "masked_actions" field.</summary>
    public const int MaskedActionsFieldNumber = 11;
    private static readonly pb::FieldCodec<bool> _repeated_maskedActions_codec
        = pb::FieldCodec.ForBool(90);
    private readonly pbc::RepeatedField<bool> maskedActions_ = new pbc::RepeatedField<bool>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<bool> MaskedActions {
      get { return maskedActions_; }
    }
    ...
    public bool Equals(AgentInfoProto other) {
      ...
      if(!maskedActions_.Equals(other.maskedActions_)) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= maskedActions_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      maskedActions_.WriteTo(output, _repeated_maskedActions_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      size += maskedActions_.CalculateSize(_repeated_maskedActions_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(AgentInfoProto other) {
      ...
      maskedActions_.Add(other.maskedActions_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 90:
          case 88: {
            maskedActions_.AddEntriesFrom(input, _repeated_maskedActions_codec);
            break;
          }
        }
      }
