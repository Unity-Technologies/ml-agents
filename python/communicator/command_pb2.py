...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='communicator/command.proto',
  package='communicator',
  syntax='proto3',
  serialized_pb=_b('\n\x1a\x63ommunicator/command.proto\x12\x0c\x63ommunicator*(\n\x07\x43ommand\x12\x08\n\x04STEP\x10\x00\x12\t\n\x05RESET\x10\x01\x12\x08\n\x04QUIT\x10\x02\x42\x18\xaa\x02\x15MLAgents.Communicatorb\x06proto3')
)

_COMMAND = _descriptor.EnumDescriptor(
  name='Command',
  full_name='communicator.Command',
  filename=None,
  file=DESCRIPTOR,
  values=[
