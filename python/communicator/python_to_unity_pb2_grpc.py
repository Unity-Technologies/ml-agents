...
class PythonToUnityStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Initialize = channel.unary_unary(
        ...
        request_serializer=communicator_dot_unity__initialization__input__pb2.UnityInitializationInput.SerializeToString,
        response_deserializer=communicator_dot_unity__initialization__output__pb2.UnityInitializationOutput.FromString,
        )
...
def add_PythonToUnityServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Initialize': grpc.unary_unary_rpc_method_handler(
          servicer.Initialize,
          request_deserializer=communicator_dot_unity__initialization__input__pb2.UnityInitializationInput.FromString,
          response_serializer=communicator_dot_unity__initialization__output__pb2.UnityInitializationOutput.SerializeToString,
      ),
