...
from mlagentsenvs.envs.communicator_objects.observation_pb2 import (
    ObservationProto as mlagentsenvs___envs___communicator_objects___observation_pb2___ObservationProto,
)
...
class AgentInfoProto(google___protobuf___message___Message):
    ...
    @property
    def observations(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[mlagentsenvs___envs___communicator_objects___observation_pb2___ObservationProto]: ...
    ...
    def __init__(self,
        *,
        ...
        observations : typing___Optional[typing___Iterable[mlagentsenvs___envs___communicator_objects___observation_pb2___ObservationProto]] = None,
        ) -> None: ...
    @classmethod
