...
from mlagentsenvs.envs.communicator_objects import agent_info_pb2 as mlagentsenvs_dot_envs_dot_communicator__objects_dot_agent__info__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsenvs/envs/communicator_objects/unity_rl_output.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\n<mlagentsenvs/envs/communicator_objects/unity_rl_output.proto\x12\x14\x63ommunicator_objects\x1a\x37mlagentsenvs/envs/communicator_objects/agent_info.proto\"\xa3\x02\n\x12UnityRLOutputProto\x12L\n\nagentInfos\x18\x02 \x03(\x0b\x32\x38.communicator_objects.UnityRLOutputProto.AgentInfosEntry\x1aI\n\x12ListAgentInfoProto\x12\x33\n\x05value\x18\x01 \x03(\x0b\x32$.communicator_objects.AgentInfoProto\x1an\n\x0f\x41gentInfosEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12J\n\x05value\x18\x02 \x01(\x0b\x32;.communicator_objects.UnityRLOutputProto.ListAgentInfoProto:\x02\x38\x01J\x04\x08\x01\x10\x02\x42\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsenvs_dot_envs_dot_communicator__objects_dot_agent__info__pb2.DESCRIPTOR,])
...
_UNITYRLOUTPUTPROTO_LISTAGENTINFOPROTO.fields_by_name['value'].message_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_agent__info__pb2._AGENTINFOPROTO
...
UnityRLOutputProto = _reflection.GeneratedProtocolMessageType('UnityRLOutputProto', (_message.Message,), dict(
  ...
  ListAgentInfoProto = _reflection.GeneratedProtocolMessageType('ListAgentInfoProto', (_message.Message,), dict(
    ...
    __module__ = 'mlagentsenvs.envs.communicator_objects.unity_rl_output_pb2'
