...
from mlagentsenvs.envs.communicator_objects import space_type_pb2 as mlagentsenvs_dot_envs_dot_communicator__objects_dot_space__type__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsenvs/envs/communicator_objects/brain_parameters.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\n=mlagentsenvs/envs/communicator_objects/brain_parameters.proto\x12\x14\x63ommunicator_objects\x1a\x37mlagentsenvs/envs/communicator_objects/space_type.proto\"\xd9\x01\n\x14\x42rainParametersProto\x12\x1a\n\x12vector_action_size\x18\x03 \x03(\x05\x12\"\n\x1avector_action_descriptions\x18\x05 \x03(\t\x12\x46\n\x18vector_action_space_type\x18\x06 \x01(\x0e\x32$.communicator_objects.SpaceTypeProto\x12\x12\n\nbrain_name\x18\x07 \x01(\t\x12\x13\n\x0bis_training\x18\x08 \x01(\x08J\x04\x08\x01\x10\x02J\x04\x08\x02\x10\x03J\x04\x08\x04\x10\x05\x42\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsenvs_dot_envs_dot_communicator__objects_dot_space__type__pb2.DESCRIPTOR,])
...
_BRAINPARAMETERSPROTO.fields_by_name['vector_action_space_type'].enum_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_space__type__pb2._SPACETYPEPROTO
...
BrainParametersProto = _reflection.GeneratedProtocolMessageType('BrainParametersProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagentsenvs.envs.communicator_objects.brain_parameters_pb2'
