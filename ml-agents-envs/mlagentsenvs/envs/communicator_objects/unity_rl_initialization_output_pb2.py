...
# source: mlagentsenvs/envs/communicator_objects/unity_rl_initialization_output.proto
...
from mlagentsenvs.envs.communicator_objects import brain_parameters_pb2 as mlagentsenvs_dot_envs_dot_communicator__objects_dot_brain__parameters__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsenvs/envs/communicator_objects/unity_rl_initialization_output.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\nKmlagentsenvs/envs/communicator_objects/unity_rl_initialization_output.proto\x12\x14\x63ommunicator_objects\x1a=mlagentsenvs/envs/communicator_objects/brain_parameters.proto\x1a\x43mlagentsenvs/envs/communicator_objects/environment_parameters.proto\"\xeb\x01\n UnityRLInitializationOutputProto\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x0f\n\x07version\x18\x02 \x01(\t\x12\x10\n\x08log_path\x18\x03 \x01(\t\x12\x44\n\x10\x62rain_parameters\x18\x05 \x03(\x0b\x32*.communicator_objects.BrainParametersProto\x12P\n\x16\x65nvironment_parameters\x18\x06 \x01(\x0b\x32\x30.communicator_objects.EnvironmentParametersProtoB\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsenvs_dot_envs_dot_communicator__objects_dot_brain__parameters__pb2.DESCRIPTOR,mlagentsenvs_dot_envs_dot_communicator__objects_dot_environment__parameters__pb2.DESCRIPTOR,])
...
_UNITYRLINITIALIZATIONOUTPUTPROTO.fields_by_name['brain_parameters'].message_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_brain__parameters__pb2._BRAINPARAMETERSPROTO
_UNITYRLINITIALIZATIONOUTPUTPROTO.fields_by_name['environment_parameters'].message_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_environment__parameters__pb2._ENVIRONMENTPARAMETERSPROTO
...
UnityRLInitializationOutputProto = _reflection.GeneratedProtocolMessageType('UnityRLInitializationOutputProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagentsenvs.envs.communicator_objects.unity_rl_initialization_output_pb2'
