...
from mlagentsenvs.envs.communicator_objects.agent_info_pb2 import (
    AgentInfoProto as mlagentsenvs___envs___communicator_objects___agent_info_pb2___AgentInfoProto,
)
...
class UnityRLOutputProto(google___protobuf___message___Message):
    ...
    class ListAgentInfoProto(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[mlagentsenvs___envs___communicator_objects___agent_info_pb2___AgentInfoProto]: ...

        def __init__(self,
            *,
            value : typing___Optional[typing___Iterable[mlagentsenvs___envs___communicator_objects___agent_info_pb2___AgentInfoProto]] = None,
            ) -> None: ...
        @classmethod
