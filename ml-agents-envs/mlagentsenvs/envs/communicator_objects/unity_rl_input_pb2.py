...
from mlagentsenvs.envs.communicator_objects import agent_action_pb2 as mlagentsenvs_dot_envs_dot_communicator__objects_dot_agent__action__pb2
from mlagentsenvs.envs.communicator_objects import environment_parameters_pb2 as mlagentsenvs_dot_envs_dot_communicator__objects_dot_environment__parameters__pb2
from mlagentsenvs.envs.communicator_objects import command_pb2 as mlagentsenvs_dot_envs_dot_communicator__objects_dot_command__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsenvs/envs/communicator_objects/unity_rl_input.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\n;mlagentsenvs/envs/communicator_objects/unity_rl_input.proto\x12\x14\x63ommunicator_objects\x1a\x39mlagentsenvs/envs/communicator_objects/agent_action.proto\x1a\x43mlagentsenvs/envs/communicator_objects/environment_parameters.proto\x1a\x34mlagentsenvs/envs/communicator_objects/command.proto\"\xc3\x03\n\x11UnityRLInputProto\x12P\n\ragent_actions\x18\x01 \x03(\x0b\x32\x39.communicator_objects.UnityRLInputProto.AgentActionsEntry\x12P\n\x16\x65nvironment_parameters\x18\x02 \x01(\x0b\x32\x30.communicator_objects.EnvironmentParametersProto\x12\x13\n\x0bis_training\x18\x03 \x01(\x08\x12\x33\n\x07\x63ommand\x18\x04 \x01(\x0e\x32\".communicator_objects.CommandProto\x1aM\n\x14ListAgentActionProto\x12\x35\n\x05value\x18\x01 \x03(\x0b\x32&.communicator_objects.AgentActionProto\x1aq\n\x11\x41gentActionsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12K\n\x05value\x18\x02 \x01(\x0b\x32<.communicator_objects.UnityRLInputProto.ListAgentActionProto:\x02\x38\x01\x42\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsenvs_dot_envs_dot_communicator__objects_dot_agent__action__pb2.DESCRIPTOR,mlagentsenvs_dot_envs_dot_communicator__objects_dot_environment__parameters__pb2.DESCRIPTOR,mlagentsenvs_dot_envs_dot_communicator__objects_dot_command__pb2.DESCRIPTOR,])
...
_UNITYRLINPUTPROTO_LISTAGENTACTIONPROTO.fields_by_name['value'].message_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_agent__action__pb2._AGENTACTIONPROTO
...
_UNITYRLINPUTPROTO.fields_by_name['environment_parameters'].message_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_environment__parameters__pb2._ENVIRONMENTPARAMETERSPROTO
_UNITYRLINPUTPROTO.fields_by_name['command'].enum_type = mlagentsenvs_dot_envs_dot_communicator__objects_dot_command__pb2._COMMANDPROTO
...
UnityRLInputProto = _reflection.GeneratedProtocolMessageType('UnityRLInputProto', (_message.Message,), dict(
  ...
  ListAgentActionProto = _reflection.GeneratedProtocolMessageType('ListAgentActionProto', (_message.Message,), dict(
    ...
    __module__ = 'mlagentsenvs.envs.communicator_objects.unity_rl_input_pb2'
