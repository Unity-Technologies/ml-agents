...
_COMMANDPROTO = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="STEP", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RESET", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="QUIT", index=2, number=2, options=None, type=None
        ),
    ],
...
DESCRIPTOR._options = _descriptor._ParseOptions(
    descriptor_pb2.FileOptions(), _b("\252\002\034MLAgents.CommunicatorObjects")
)
