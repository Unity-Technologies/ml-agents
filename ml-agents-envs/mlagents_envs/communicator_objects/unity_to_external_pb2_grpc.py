...
class UnityToExternalStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Exchange = channel.unary_unary(
        ...
        request_serializer=mlagents__envs_dot_communicator__objects_dot_unity__message__pb2.UnityMessage.SerializeToString,
        response_deserializer=mlagents__envs_dot_communicator__objects_dot_unity__message__pb2.UnityMessage.FromString,
        )
...
def add_UnityToExternalServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Exchange': grpc.unary_unary_rpc_method_handler(
          servicer.Exchange,
          request_deserializer=mlagents__envs_dot_communicator__objects_dot_unity__message__pb2.UnityMessage.FromString,
          response_serializer=mlagents__envs_dot_communicator__objects_dot_unity__message__pb2.UnityMessage.SerializeToString,
      ),
  }
