...
from mlagents_envs.communicator_objects import agent_action_proto_pb2 as mlagents__envs_dot_communicator__objects_dot_agent__action__proto__pb2
from mlagents_envs.communicator_objects import environment_parameters_proto_pb2 as mlagents__envs_dot_communicator__objects_dot_environment__parameters__proto__pb2
from mlagents_envs.communicator_objects import command_proto_pb2 as mlagents__envs_dot_communicator__objects_dot_command__proto__pb2
...
_UNITYRLINPUT_LISTAGENTACTIONPROTO.fields_by_name['value'].message_type = mlagents__envs_dot_communicator__objects_dot_agent__action__proto__pb2._AGENTACTIONPROTO
...
_UNITYRLINPUT.fields_by_name['environment_parameters'].message_type = mlagents__envs_dot_communicator__objects_dot_environment__parameters__proto__pb2._ENVIRONMENTPARAMETERSPROTO
_UNITYRLINPUT.fields_by_name['command'].enum_type = mlagents__envs_dot_communicator__objects_dot_command__proto__pb2._COMMANDPROTO
