...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n;mlagents_envs/communicator_objects/training_analytics.proto\x12\x14\x63ommunicator_objects\"\xd8\x01\n\x1eTrainingEnvironmentInitialized\x12\x18\n\x10mlagents_version\x18\x01 \x01(\t\x12\x1d\n\x15mlagents_envs_version\x18\x02 \x01(\t\x12\x16\n\x0epython_version\x18\x03 \x01(\t\x12\x15\n\rtorch_version\x18\x04 \x01(\t\x12\x19\n\x11torch_device_type\x18\x05 \x01(\t\x12\x10\n\x08num_envs\x18\x06 \x01(\x05\x12!\n\x19num_randomized_parameters\x18\x07 \x01(\x05\"\xfd\x02\n\x1bTrainingBehaviorInitialized\x12 \n\x18\x65xtrinsic_reward_enabled\x18\x01 \x01(\x08\x12\x1b\n\x13gail_reward_enabled\x18\x02 \x01(\x08\x12 \n\x18\x63uriosity_reward_enabled\x18\x03 \x01(\x08\x12\x1a\n\x12rnd_reward_enabled\x18\x04 \x01(\x08\x12\"\n\x1a\x62\x65havioral_cloning_enabled\x18\x05 \x01(\x08\x12\x19\n\x11recurrent_enabled\x18\x06 \x01(\x08\x12\x16\n\x0evisual_encoder\x18\x07 \x01(\t\x12\x1a\n\x12num_network_layers\x18\x08 \x01(\x05\x12 \n\x18num_network_hidden_units\x18\t \x01(\x05\x12\x18\n\x10trainer_threaded\x18\n \x01(\x08\x12\x19\n\x11self_play_enabled\x18\x0b \x01(\x08\x12\x17\n\x0fuses_curriculum\x18\x0c \x01(\x08\x42%\xaa\x02\"Unity.MLAgents.CommunicatorObjectsb\x06proto3')
)
...
_TRAININGENVIRONMENTINITIALIZED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_randomized_parameters', full_name='communicator_objects.TrainingEnvironmentInitialized.num_randomized_parameters', index=6,
...
_TRAININGBEHAVIORINITIALIZED = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='extrinsic_reward_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.extrinsic_reward_enabled', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gail_reward_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.gail_reward_enabled', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='curiosity_reward_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.curiosity_reward_enabled', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rnd_reward_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.rnd_reward_enabled', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='behavioral_cloning_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.behavioral_cloning_enabled', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recurrent_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.recurrent_enabled', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='visual_encoder', full_name='communicator_objects.TrainingBehaviorInitialized.visual_encoder', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_network_layers', full_name='communicator_objects.TrainingBehaviorInitialized.num_network_layers', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_network_hidden_units', full_name='communicator_objects.TrainingBehaviorInitialized.num_network_hidden_units', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='trainer_threaded', full_name='communicator_objects.TrainingBehaviorInitialized.trainer_threaded', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='self_play_enabled', full_name='communicator_objects.TrainingBehaviorInitialized.self_play_enabled', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uses_curriculum', full_name='communicator_objects.TrainingBehaviorInitialized.uses_curriculum', index=11,
