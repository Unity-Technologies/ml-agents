...
class ObservationProto(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"compressed_data",u"compression_type",u"float_data",u"mapping",u"observation_data",u"shape"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"compressed_data",b"compressed_data",u"compression_type",b"compression_type",u"float_data",b"float_data",u"mapping",b"mapping",u"observation_data",b"observation_data",u"shape",b"shape"]) -> None: ...
