...
{
    public static class TestInputActionAsset
    {
        public static InputActionAsset GetTestAsset()
        {
            // Test asset based on an example environment.
            return InputActionAsset.FromJson(@"{
