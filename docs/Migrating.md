...
* The `SetActionMask` was renamed to `SetDiscreteActionMask` method must now be called on the `ActionMasker` argument of the `CollectDiscreteActionMasks` virtual method.
