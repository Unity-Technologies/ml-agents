...
ML-Agents Toolkit은 유니티의 자유로운 환경에서 인공지능 에이전트를 개발하기 위한 기반을 제공하며, 이틀 통해 연구자 및 게임 개발자 등 광범위한 커뮤니티에 접근할 수 있기 때문에 게임 개발자와 인공지능 연구원 모두에게 상호 이익이 됩니다.
...
박우진: [woojin.park@unity3d.com](mailto:woojin.park@unity3d.com), [pnltoen@naver.com](mailto:pnltoen@gmail.com)
