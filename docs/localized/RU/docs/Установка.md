...
- Установить Unity (2020.3 или более позднюю версию)
- Установить Python (3.7.2 или более позднюю версию)
...
### Установка **Unity 2020.3** или более поздней версии
...
### Установка **Python 3.7.2** или более поздней версии

Мы рекомендуем [установить](https://www.python.org/downloads/) Python 3.7.
