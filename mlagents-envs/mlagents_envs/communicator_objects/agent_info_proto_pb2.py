...
# source: mlagents/mlagents_envs/communicator_objects/agent_info_proto.proto
...
AgentInfoProto = _reflection.GeneratedProtocolMessageType('AgentInfoProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagents.mlagents_envs.communicator_objects.agent_info_proto_pb2'
