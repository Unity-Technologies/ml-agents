...
# source: mlagents/mlagents_envs/communicator_objects/engine_configuration_proto.proto
...
EngineConfigurationProto = _reflection.GeneratedProtocolMessageType('EngineConfigurationProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagents.mlagents_envs.communicator_objects.engine_configuration_proto_pb2'
