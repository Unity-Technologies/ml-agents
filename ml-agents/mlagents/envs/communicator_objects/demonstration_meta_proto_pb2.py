...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\nAmlagents/envs/communicator_objects/demonstration_meta_proto.proto\x12\x14\x63ommunicator_objects\"q\n\x16\x44\x65monstrationMetaProto\x12\x13\n\x0b\x61pi_version\x18\x01 \x01(\x05\x12\x14\n\x0cnumber_steps\x18\x02 \x01(\x05\x12\x17\n\x0fnumber_episodes\x18\x03 \x01(\x05\x12\x13\n\x0bmean_reward\x18\x04 \x01(\x02\x42\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
)
...
_DEMONSTRATIONMETAPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='number_steps', full_name='communicator_objects.DemonstrationMetaProto.number_steps', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='number_episodes', full_name='communicator_objects.DemonstrationMetaProto.number_episodes', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mean_reward', full_name='communicator_objects.DemonstrationMetaProto.mean_reward', index=3,
