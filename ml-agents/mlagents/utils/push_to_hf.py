...
def _generate_model_card(repo_local_path: Path, configfile_name: str, repo_id: str):
    """
...
def _save_model_card(repo_dir: Path, generated_model_card: str, metadata: dict):
