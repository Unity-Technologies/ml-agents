...
from mlagents.trainers.lsac.optimizer_torch import TorchLSACOptimizer, LSACSettings
...
class LSACTrainer(OffPolicyTrainer):
    """
    The LSACTrainer is an implementation of the LSAC algorithm.
    """
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training LSAC model.
        ...
        self.optimizer: TorchLSACOptimizer = None  # type: ignore
        self.hyperparameters: LSACSettings = cast(
            LSACSettings, trainer_settings.hyperparameters
        )
        self._step = 0
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchLSACOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and LSAC hyperparameters
