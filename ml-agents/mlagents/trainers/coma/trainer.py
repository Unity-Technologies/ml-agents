...
# ## ML-Agents Learning (COMA)
# Contains an implementation of MA-COMA.
...
class COMATrainer(RLTrainer):
    """The COMATrainer is an implementation of the MA-COMA algorithm."""
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training COMA model.
    ...
    def end_episode(self) -> None:
        ...
        Get only called when the academy resets. For COMA, we should
    ...
    def create_torch_policy(
        ...
        """
        Creates a policy with a PyTorch backend and COMA hyperparameters
        ...
        policy = TorchPolicy(
            ...
            condition_sigma_on_obs=False,  # Faster training for COMA
