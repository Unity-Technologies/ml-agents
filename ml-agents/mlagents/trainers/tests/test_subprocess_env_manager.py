...
class SubprocessEnvManagerTest(unittest.TestCase):
    ...
    @mock.patch(
        "mlagents.trainers.subprocess_env_manager.SubprocessEnvManager.external_behaviors",
        new_callable=mock.PropertyMock,
    )
    @mock.patch(
        "mlagents.trainers.subprocess_env_manager.SubprocessEnvManager.create_worker"
    )
    def test_advance(self, mock_create_worker, external_behaviors_mock, step_mock):
        ...
        external_behaviors_mock.return_value = [brain_name]
