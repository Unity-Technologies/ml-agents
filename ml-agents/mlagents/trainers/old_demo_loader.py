...
from mlagents.envs.communicator_objects_old.agent_info_pb2 import AgentInfoProto
...
def make_demo_buffer(
    brain_infos: List[AgentInfoProto],
    ...
    for idx, experience in enumerate(brain_infos):
        ...
        current_brain_info = BrainInfo.from_agent_proto(
            0, [brain_infos[idx]], brain_params
        )
        next_brain_info = BrainInfo.from_agent_proto(
            0, [brain_infos[idx + 1]], brain_params
        )
        ...
        demo_buffer[0]["actions"].append(brain_infos[idx + 1].stored_vector_actions)
        demo_buffer[0]["prev_action"].append(brain_infos[idx].stored_vector_actions)
