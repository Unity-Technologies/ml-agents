...
from mlagents.trainers.bisac.optimizer_torch import TorchBiSACOptimizer, BiSACSettings
...
class BiSACTrainer(OffPolicyTrainer):
    """
    The BiSACTrainer is an implementation of the BiSAC algorithm.
    """
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training BiSAC model.
        ...
        self.optimizer: TorchBiSACOptimizer = None  # type: ignore
        self.hyperparameters: BiSACSettings = cast(
            BiSACSettings, trainer_settings.hyperparameters
        )
        self._step = 0
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchBiSACOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and BiSAC hyperparameters
