...
class BehaviorClone(object):
    ...
    def __init__(self, policy_model: LearningModel, brain, parameters):
    ...
    def concat_demos(self, mini_batch, num_sequences):
        """
        ...
        demo_batch = update_buffer.make_mini_batch(start, end)
