...
RUN echo "deb http://packages.cloud.google.com/apt cloud-sdk-xenial master" | tee -a /etc/apt/sources.list.d/google-cloud-sdk.list
...
RUN apt-get update && \
  ...
  wget http://security.ubuntu.com/ubuntu/pool/master/libx/libxfont/libxfont1_1.5.1-1ubuntu0.16.04.4_amd64.deb && \
