...
namespace Unity.MLAgents.Tests
{
    public class GridSensorTests
    {
        ...
        public void TestMultipleSensors()
        {
            ...
            Assert.IsNotNull(((GridSensorBase)gridSensors[0]).m_OverlapChecker);
            Assert.IsNull(((GridSensorBase)gridSensors[1]).m_OverlapChecker);
            Assert.IsNull(((GridSensorBase)gridSensors[2]).m_OverlapChecker);
        }
