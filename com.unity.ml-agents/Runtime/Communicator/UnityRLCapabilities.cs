...
namespace Unity.MLAgents
{
    internal class UnityRLCapabilities
    {
        ...
        public bool CompressionMappings;
        ...
        /// </summary>
        public UnityRLCapabilities(bool baseRlCapabilities = true, bool concatenatedPngObservations = true, bool compressionMappings = true)
        {
