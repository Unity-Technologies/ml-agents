...
namespace Unity.MLAgents.CommunicatorObjects {
    ...
    static UnityRlOutputReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Unity.MLAgents.CommunicatorObjects.UnityRLOutputProto), global::Unity.MLAgents.CommunicatorObjects.UnityRLOutputProto.Parser, new[]{ "AgentInfos", "SideChannel" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { new pbr::GeneratedClrTypeInfo(typeof(global::Unity.MLAgents.CommunicatorObjects.UnityRLOutputProto.Types.ListAgentInfoProto), global::Unity.MLAgents.CommunicatorObjects.UnityRLOutputProto.Types.ListAgentInfoProto.Parser, new[]{ "Value" }, null, null, null, null),
            null, })
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      agentInfos_.WriteTo(ref output, _map_agentInfos_codec);
      if (SideChannel.Length != 0) {
        output.WriteRawTag(26);
        output.WriteBytes(SideChannel);
      }
    ...
    public void MergeFrom(UnityRLOutputProto other) {
      ...
      agentInfos_.MergeFrom(other.agentInfos_);
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 18: {
            agentInfos_.AddEntriesFrom(ref input, _map_agentInfos_codec);
            break;
          }
          case 26: {
            SideChannel = input.ReadBytes();
